...
import {
  ...
  revokeAward,
  reviseBadge,
  setBadgeAvailability,
} from './group-badge-actions';
import type { GroupBadgesPageModel } from './group-badges-data';
...
export function GroupBadgesView({ model }: { model: GroupBadgesPageModel }) {
  const {
    group,
    definitions,
    candidates,
